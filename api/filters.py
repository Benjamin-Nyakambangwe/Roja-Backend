...
class PropertyFilter(django_filters.FilterSet):
    ...
    deposit_min = django_filters.NumberFilter(
        field_name='deposit', lookup_expr='gte')
    deposit_max = django_filters.NumberFilter(
        field_name='deposit', lookup_expr='lte')
    ...
    area_min = django_filters.NumberFilter(
        field_name='area', lookup_expr='gte')
    area_max = django_filters.NumberFilter(
        field_name='area', lookup_expr='lte')
    is_available = django_filters.BooleanFilter()
    preferred_lease_term_min = django_filters.NumberFilter(
        field_name='preferred_lease_term', lookup_expr='gte')
    preferred_lease_term_max = django_filters.NumberFilter(
        field_name='preferred_lease_term', lookup_expr='lte')
    accepts_pets = django_filters.BooleanFilter()
    pet_deposit_min = django_filters.NumberFilter(
        field_name='pet_deposit', lookup_expr='gte')
    pet_deposit_max = django_filters.NumberFilter(
        field_name='pet_deposit', lookup_expr='lte')
    accepts_smokers = django_filters.BooleanFilter()
    pool = django_filters.BooleanFilter()
    garden = django_filters.BooleanFilter()
    has_solar_power = django_filters.BooleanFilter()
    ...
    class Meta:
        ...
        fields = ['title', 'description', 'address', 'price', 'deposit', 'bedrooms', 'bathrooms', 'area',
                  ...
                  'pool', 'garden', 'has_solar_power', 'has_borehole', 'type', 'location']
