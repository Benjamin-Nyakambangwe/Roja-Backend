...
class PropertyAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'owner', 'price', 'bedrooms', 'bathrooms',
                    'accepts_pets', 'has_solar_power', 'has_borehole', 'is_available')
    list_filter = ('is_available', 'bedrooms', 'bathrooms',
                   'accepts_pets', 'has_solar_power', 'has_borehole')
...
class LeaseAgreementAdmin(admin.ModelAdmin):
    list_display = ('tenant', 'property', 'start_date',
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ('property', 'commenter', 'is_owner',
...
class RentPaymentAdmin(admin.ModelAdmin):
    list_display = ('property', 'tenant', 'amount', 'due_date',
